...
class _$_AccountState implements _AccountState {
  const _$_AccountState({this.isLoading = false, this.error, this.data});
  ...
  @override
  String toString() {
    return 'AccountState(isLoading: $isLoading, error: $error, data: $data)';
  }
...
abstract class _AccountState implements AccountState {
  const factory _AccountState(
      {final dynamic isLoading,
      final Failure? error,
      final dynamic data}) = _$_AccountState;
